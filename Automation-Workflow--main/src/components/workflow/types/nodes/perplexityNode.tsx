...
const modelOptions = ['pplx-7b-online', 'pplx-70b-online', 'pplx-7b-chat'];

const PerplexityNode: React.FC<any> = ({ id, data, selected }) => {
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-md overflow-hidden ${
        selected ? 'ring-2 ring-rose-500' : 'border border-gray-200'
      }`}
    >
      {/* Header */}
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <input
            type="text"
            value={data.params?.nodeName || 'perplexity_0'}
            onChange={(e) =>
